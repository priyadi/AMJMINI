 ...
 * pin: F0  B3  B2  B1  B0  B7  D0  D1  D2  D3  D5  D6  D7  b4  B5  B6  C6
 */
static void  init_cols(void)
{
    ...
    DDRD &= ~( _BV(PD0) | _BV(PD1) | _BV(PD2) | _BV(PD3) | _BV(PD5) | _BV(PD6) | _BV(PD7));
    PORTD |= ( _BV(PD0) | _BV(PD1) | _BV(PD2) | _BV(PD3) | _BV(PD5) | _BV(PD6) | _BV(PD7));
...
static matrix_row_t read_cols(void)
{
    return (PINF&_BV(PF0) ? 0 : (1<<0)) |
           ...
           (PINB&_BV(PB4) ? 0 : (1<<13)) |
           (PINB&_BV(PB5) ? 0 : (1<<14)) |
           (PINB&_BV(PB6) ? 0 : (1UL<<15)) |
           (PINC&_BV(PC6) ? 0 : (1UL<<16));
}
